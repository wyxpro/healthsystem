...
@Api(value = "")
@RestController
@RequestMapping("/scale/ps")
public class PerceivedStressController {
    @Autowired
    ...
    public Response addOrUpdateScale(@RequestBody PerceivedStress perceivedStress) {
        Response insert = perceivedStressService.insertOrUpdate(perceivedStress);
        return insert;
    }
    ...
    public Response getScaleList(@RequestParam int currentPage, @RequestParam int pageSize) {
        Response response = perceivedStressService.getPerceivedStressList(currentPage, pageSize);
        return response;
    }
    ...
    public Response getScaleToday() {
        Response response = perceivedStressService.getToday();
        return response;
    }
    ...
    public Response getRecentInput() {
        Response response = perceivedStressService.getRecentInput();
        return response;
    }
