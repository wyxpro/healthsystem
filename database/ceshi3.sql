...
CREATE TABLE `answer`  (
  ...
  `medicine` tinyint NOT NULL DEFAULT 0 COMMENT '是否按时服药：未知（0）（有些人可能不用服药），未按时服药（1），按时服药（2）',
  `sleep_info` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '入睡困难、睡不安、睡得多',
  `sleep_time` double(10, 1) NOT NULL DEFAULT 0.0 COMMENT '睡眠时间，单位分钟',
  `sleep_time_start` time NULL DEFAULT NULL,
  `sleep_time_end` time NULL DEFAULT NULL,
  ...
  `step_info` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `free_time` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `meal_time` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `meal_sleep_time` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `communicate_time` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `activity_info` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `dinner_time` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `breakfirst_time` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 697 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '每日一次的填报记录（睡眠时间、运动时间、服药等信息）' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of answer
-- ----------------------------
INSERT INTO `answer` VALUES (689, 171, '2024-06-12', '走路', '少于30分钟', '按时吃饭，食欲正常', 0, '我的睡眠情况与平时相比没有变化', 8.0, '01:00:00', '09:00:00', NULL, '2024-06-12 20:02:04', '2001-4000', '没有制定计划，随心情行动', '积极参与交流，享受互动时光', '1-3小时', '大多数时候能集中注意力，但不够高效', '休息或放松，做一些简单的娱乐', '30分钟-1小时', '都没有', '听音乐或看电影', '感到充实和满足', '中午12点到13点', '没有午休', '30分钟-1小时', '没有参与特别的活动', '下午18点到20点', '30分钟-1小时', '伸个懒腰，稍作休息后起床', '没吃早饭');
INSERT INTO `answer` VALUES (690, 171, '2024-06-13', '走路', '30分钟-1小时', '偶尔错过一餐，但总体还好', 0, '我的睡眠情况与平时相比没有变化', 7.5, '01:00:00', '08:20:00', NULL, '2024-06-13 19:51:03', '4001-6000', '没有制定计划，随心情行动', '较少参与交流活动，更喜欢独处', '3-5小时', '感觉很疲惫，不想工作或学习', '休息或放松，做一些简单的娱乐', '30分钟-1小时', '都没有', '玩电子游戏或上网冲浪', '感到一般，但还可以', '没吃午饭', '没有午休', '少于30分钟', '没有参与特别的活动', '下午18点前', '1-1.5小时', '伸个懒腰，稍作休息后起床', '没吃早饭');
INSERT INTO `answer` VALUES (691, 171, '2024-06-15', '走路', '30分钟-1小时', '按时吃饭，食欲正常', 0, '我的睡眠情况与平时相比没有变化', 7.0, '01:01:00', '08:00:00', NULL, '2024-06-15 00:01:59', '4001-6000', '有一定的计划但改变了', '较少参与交流活动，更喜欢独处', '1-3小时', '难以集中注意力，经常分心', '休息或放松，做一些简单的娱乐', '30分钟-1小时', '都没有', '玩电子游戏或上网冲浪', '感到充实和满足', '没吃午饭', '没有午休', '超过2小时', '没有参与特别的活动', '下午18点到20点', '1-1.5小时', '继续躺在床上，查看手机或社交媒体', '早上9点后');
INSERT INTO `answer` VALUES (693, 170, '2024-06-16', '跑步,瑜伽,骑车', '1-1.5小时', '经常忘记吃饭或吃得很少', 0, '相比平时，我需要额外一段时间才能入睡', 9.0, '23:51:00', '08:50:00', NULL, '2024-06-16 21:54:56', '6001-8000', '不知道该如何安排时间', '积极参与交流，享受互动时光', '3-5小时', '大多数时候能集中注意力，但不够高效', '几乎不让自己有空闲时间，空闲时间只会让我感到更加沮丧', '30分钟-1小时', '极度心神不宁，焦虑不安', '玩电子游戏或上网冲浪', '感到些许沮丧或失望', '中午12点到13点', '少于30分钟', '1.5-2小时', '投入时间学习或练习了某个兴趣爱好', '准备吃宵夜', '30分钟-1小时', '继续躺在床上，查看手机或社交媒体', '早上7点到8点');
INSERT INTO `answer` VALUES (694, 171, '2024-06-20', '没有运动(请您跳过下一题)', '0', '按时吃饭，食欲正常', 0, '我的睡眠情况与平时相比没有变化', 8.0, '00:16:00', '08:14:00', NULL, '2024-06-20 20:16:10', '4001-6000', '制定了清晰的时间表并按时执行', '积极参与交流，享受互动时光', '3-5小时', '大多数时候能集中注意力，但不够高效', '休息或放松，做一些简单的娱乐', '1.5-2小时', '都没有', '玩电子游戏或上网冲浪', '感到充实和满足', '中午12点到13点', '没有午休', '超过2小时', '没有参与特别的活动', '下午18点到20点', '30分钟-1小时', '立刻起床', '没吃早饭');
INSERT INTO `answer` VALUES (695, 179, '2024-06-21', '走路,骑车', '少于30分钟', '按时吃饭，食欲正常', 0, '我的睡眠情况与平时相比没有变化', 9.5, '23:30:00', '08:55:00', NULL, '2024-06-21 13:16:33', '4001-6000', '没有制定计划，随心情行动', '积极参与交流，享受互动时光', '5-8小时', '感觉很疲惫，不想工作或学习', '休息或放松，做一些简单的娱乐', '1-1.5小时', '有些心神不宁', '玩电子游戏或上网冲浪', '感到些许沮丧或失望', '中午12点前', '1-2小时', '超过2小时', '没有参与特别的活动', '下午18点到20点', '1-1.5小时', '伸个懒腰，稍作休息后起床', '没吃早饭');
INSERT INTO `answer` VALUES (696, 174, '2024-06-21', '没有运动(请您跳过下一题)', '0', '按时吃饭，食欲正常', 0, '我的睡眠情况与平时相比没有变化', 7.0, '23:59:00', '06:49:00', NULL, '2024-06-21 13:51:29', '4001-6000', '没有制定计划，随心情行动', '积极参与交流，享受互动时光', '超过8小时', '大多数时候能集中注意力，但不够高效', '休息或放松，做一些简单的娱乐', '超过2小时', '都没有', '听音乐或看电影', '感到一般，但还可以', '中午12点到13点', '没有午休', '超过2小时', '没有参与特别的活动', '准备吃宵夜', '超过2小时', '继续躺在床上，查看手机或社交媒体', '没吃早饭');
INSERT INTO `answer` VALUES (697, 171, '2024-06-23', '没有运动(请您跳过下一题)', '0', '按时吃饭，食欲正常', 0, '我的睡眠情况与平时相比没有变化', 10.0, '22:25:00', '08:24:00', NULL, '2024-06-23 15:31:00', '6001-8000', '制定了清晰的时间表并按时执行', '积极参与交流，享受互动时光', '1-3小时', '持续专注且高效', '休息或放松，做一些简单的娱乐', '超过2小时', '都没有', '与家人或朋友聊天', '感到充实和满足', '中午12点到13点', '没有午休', '超过2小时', '没有参与特别的活动', '下午18点到20点', '超过2小时', '继续躺在床上，多睡一会儿', '没吃早饭');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '用于管理后台管理端的用户，通过邀请码注册' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户健康信息' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 179 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户基本信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_info` VALUES (171, '13939948323', 'cyk', 'e10adc3949ba59abbe56e057f20f883e', 'doctor', 'vip', 'cyk', NULL, '西安市', '陕西省', '中国', '', 0, '2024-06-12 18:47:31', '2025-07-13 17:49:39', NULL, NULL, '2025-07-13 17:49:39');
INSERT INTO `user_info` VALUES (174, '15236254632', 'lx', 'e10adc3949ba59abbe56e057f20f883e', 'user', 'normal', 'lx', NULL, '西安市', '陕西省', '中国', '', 1, '2024-06-21 12:52:41', '2024-06-21 20:05:28', NULL, NULL, '2024-06-21 20:05:28');
INSERT INTO `user_info` VALUES (179, '18735482563', 'whm', 'e10adc3949ba59abbe56e057f20f883e', 'user', 'normal', 'whm', NULL, '西安市', '陕西省', '中国', '', 1, '2024-06-21 12:57:13', '2024-06-21 13:17:13', NULL, NULL, '2024-06-21 13:17:13');
