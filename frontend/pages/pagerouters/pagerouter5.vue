<template>
	<view>
		<div class="note">
			<p style="font-weight: bold; margin-bottom: 10px; font-size: 1.2rem;">走近回避型依恋者 如何寻找真爱？</p>
			<p style="margin-bottom: 10px; color: #6c6c6c">2024-04-25 | 中国网心理中国 | 迟毓凯</p>
			<p style="font-weight: bold;">回避型依恋者，也需要亲密关系</p>
			</br>
			...
			<p style="font-weight: bold;">回避型依恋的特征</p>
			</br>
			...
			<p style="font-weight: bold;">回避型依恋的形成</p>
			</br>
			...
			<p style="font-weight: bold;">回避型依恋者的自我改变</p>
			</br>
			...
			<p style="font-weight: bold;">如何与回避型依恋者谈恋爱</p>
			</br>
			...
			<p style="font-weight: bold;">回避型依恋者，如何寻找真爱</p>
			</br>
			...
			最后，对任何人来说，没有最好的爱人，只有最适合你的伴侣。回避型依恋不是问题，只要不放弃爱、妥善经营自己的亲密关系，相信你总能在爱中获得幸福和满足。
			</br></br>
			<p style="color: #6c6c6c;">（迟毓凯/华南师范大学心理学院）</p>
		</div>
	</view>
</template>
